...
$patron = "/localhost/i";
$sujeto = $_SERVER['HTTP_HOST'];
	
return preg_match($patron, $sujeto);
...
define('DB_NAME', 'grupoig');     // The name of the database
...
define('DB_HOST', 'xxxxx');     // ...and the server MySQL is running on
