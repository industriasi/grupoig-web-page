...
<div class="container clearfix page blog-default <?php echo $hasSidebar; ?>"> <!--  Start of main container -->
		...
		<div class="breadcrumb clearfix"><?php $helper->the_breadcrumb();?></div><!--  Breadcrumb -->
		  <div class="content clearfix ">
		     ...
		     <div class="<?php if($sidebar=="true") echo 'two-third-width clearfix'; else echo 'full-width clearfix';  ?>">  
	                ...
	                ?>
                      ...
                      <?php 
			           ...
			           if(get_post_meta(get_the_ID(),"_custom_thumbnails_select",true)=="video") :  
			                echo ' <div class="imageholder videoholder">
							            <a href="#">'.get_post_meta(get_the_ID(),"_custom_thumbnail_video",true)."</a>
								   </div>";               
				       elseif(get_post_meta(get_the_ID(),"_custom_thumbnails_select",true)=="slideshow") :
							...
							if (isset($blog_id) && $blog_id > 0) {
				             ...
				             $slideshow = $slideshow. "<li>
							     <img src='".get_bloginfo('template_directory')."/timthumb.php?src=".urlencode($theImageSrc)."&amp;h=170&amp;w=255' alt='slideshow'  /></li>";
                     ...
                     <div class="imageholder">
                      ...
                      <div class="description <?php echo $width;?> ">
                              ...
                              <?php the_excerpt(); ?>
                               ...
                               <small class='post-info'><?php echo get_the_date("j F Y"); ?> by <?php the_author_posts_link() ?></small>
                              ...
                              echo "<span  class='post-categories'> $str </span>";
                               ?>
                ...
                <li class="separator separator-full"><span></span></li>
          <?php  $i++; endwhile; else:
