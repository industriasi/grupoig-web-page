<?php
/*
Template Name: Portfolio Wall Page Template
*/
?>
   	...
   	<div class="<?php if($sidebar=="true") echo 'two-third-width'; else echo 'full-width';  ?>">
        <div class="clearfix content-wrapper">
            ...
            <!--   <div class="portfolio-taxonomy clearfix">
              ...
              <div class="portfolio-wall-column portfolio">
              
              <?php $helper->showWallPosts(array( "post_type"=>"portfolio" , "image_width"=> 275 , "image_height"=> 170, 'extras' => true ));  ?>
