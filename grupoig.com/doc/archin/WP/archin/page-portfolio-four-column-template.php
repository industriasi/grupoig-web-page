<?php
/*
Template Name: Portfolio 4 Column Page Template
*/
?>

<?php 
    $items_limit = get_option("arc_portfolio4_item_limit");
	$items_limit =  (!$items_limit) ? 6 : $items_limit ; 
	
    $limit = get_option("arc_portfolio4_limit");
   	...
   	<div class="<?php if($sidebar=="true") echo 'two-third-width'; else echo 'full-width';  ?>">
        <div class="clearfix content-wrapper">
            ...
            <div class="page-content">
              ...
              <?php $helper->showPortfolioPosts(array( "post_type"=>"portfolio" , "image_width"=> 210 , "image_height"=> 145, 'extras' => true , 'clear' => 4 , 'content_limit' => $limit , 'limit'=> $items_limit ));  ?>
