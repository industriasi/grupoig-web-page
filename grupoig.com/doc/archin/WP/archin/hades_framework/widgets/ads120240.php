...
class Ads120240 extends WP_Widget {
	
	function Ads120240() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Ads120240', 'description' => __('Create a 2 ads slot with dimension 120 by 240px.','h-framework') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 300 );
		 $this->WP_Widget(false,__("Create Ad 120x240",'h-framework'),$widget_ops,$control_ops); }
...
<?php
	...
	$url1 = $instance['url1'];
		...
		if($title!="")
		echo $before_title.' '.$instance['title']; echo $after_title;
		
		?> 
		
        <ul class="clearfix ads120240">
