...
class Ads240 extends WP_Widget {
	
	function Ads240() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Ads240', 'description' => __('Create a ad slot with dimension 240 by 400px.') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 300 );
		 $this->WP_Widget(false,__("Create Ad 240x400",'h-framework'),$widget_ops,$control_ops); }
...
<?php
	...
	$url = $instance['url'];
	  $title = $instance['title'];
		...
		echo "<a href='$url' class='ads240' ><img src='$img' alt='image' /> </a>"; 
		echo $after_widget; 
